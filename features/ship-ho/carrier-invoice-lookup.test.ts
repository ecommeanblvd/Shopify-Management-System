...
const raw: RawBillLine = {
  ...
  demand: '25000', signature: '0', vat: '150000', other: '0', total: '1305000', shipDate: '2026-07-02',
};
...
describe('normalizeBilledLine', () => {
  ...
  it('null/rỗng → 0 cho phụ phí, weight null', () => {
    const empty: RawBillLine = { weightKg: null, base: null, discount: null, fuel: null, remote: null, demand: null, signature: null, vat: null, other: null, total: '0', shipDate: null };
