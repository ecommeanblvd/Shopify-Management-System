...
**Jenny K Tran | Divine (09/09/2026):** tiêu đề "Brand: JENNY K TRAN | DIVINE" (bộ đọc lấy phần trước "|"); USD; dòng tổng ₫ tên "TỔNG CÔNG NỢ MEAN THANH TOÁN:" (mọi dòng bắt đầu "TỔNG" có ₫ trước mục B đều là mốc A); Note có VND nhưng T3/T5 lệch tổng → bỏ, dùng tỉ giá tổng. Chưa có tab T8 thực nhận. 7/7 kỳ Σ = tổng ₫ brand (≤ 2đ).
