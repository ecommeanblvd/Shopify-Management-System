/**
 * Shared helpers for the Recently Viewed storefront API. Mirrors the
 * wishlist `_shared.ts` — kept duplicated rather than generalised so
 * each function can evolve its own CORS / auth strategy independently.
 */
