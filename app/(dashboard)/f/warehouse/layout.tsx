 ...
 *
 * Thứ tự tab đặt theo việc kho làm HẰNG NGÀY: "Nhận & kiểm hàng" (bám bảng Lark, 9.007 dòng)
 * lên đầu nhóm nhập kho; ba tab của quy trình phiếu nhập cũ trong SMS (757 dòng, kho không
 * dùng) lùi xuống và gắn chữ "cũ" để không ai vào nhầm — CEO 23/09/2026.
 */
